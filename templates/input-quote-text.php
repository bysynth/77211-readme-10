...
<div class="form__input-section <?= isset($error) ? 'form__input-section--error' : '' ?>">
    <textarea class="adding-post__textarea adding-post__textarea--quote form__textarea form__input" id="quote-text" name="quote-content" placeholder="Текст цитаты"><?= get_post_val('quote-content')?></textarea>
