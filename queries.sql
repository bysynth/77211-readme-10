...
INSERT INTO posts (create_date, title, text_content, cite_author, image, video, link, view_tally, is_repost, author_id,
                   original_author_id, content_type, hashtags_posts_id)
VALUES ('2018-04-10 10:40:00', 'Цитата', 'Мы в жизни любим только раз, а после ищем лишь похожих', 'Сергей Есенин',
        NULL, NULL, NULL, 35640, 0, 1, NULL, 2, 1),
       ('2018-10-28 09:10:15', 'Игра престолов', 'Не могу дождаться начала финального сезона своего любимого сериала!',
        NULL, NULL, NULL, NULL, 26187, 0, 2, NULL, 1, 2),
       ('2019-01-09 15:01:36', 'Наконец, обработал фотки!', NULL, NULL, 'rock-medium.jpg', NULL, NULL, 16501, 0, 3,
        NULL, 3, 3),
       ('2019-03-03 18:46:01', 'Моя мечта', NULL, NULL, 'coast-medium.jpg', NULL, NULL, 12349, 0, 4, NULL, 3, 4),
       ('2019-05-10 07:02:23', 'Лучшие курсы', NULL, NULL, NULL, NULL, 'www.htmlacademy.ru', 5784, 0, 5, NULL, 5, 5);

INSERT INTO comments (create_date, comment, author_id, post_id)
...
SELECT post_id, title, name, type_name, view_tally
FROM posts
         JOIN users
              ON user_id = author_id
         JOIN content_types
              ON content_type_id = content_type
ORDER BY view_tally DESC;
